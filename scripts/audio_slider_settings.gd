...
func _ready():
	...
	get_bus_name_by_indux()
	set_name_label_text()
	set_slider_value()

func on_value_changed(value : float) -> void:
	AudioServer.set_bus_volume_db(bus_indux, linear_to_db(value))
	set_audio_num_label_text()

func set_slider_value() -> void:
	h_slider.value = db_to_linear(AudioServer.get_bus_volume_db(bus_indux))
	set_audio_num_label_text()
...
func get_bus_name_by_indux() -> void:
	bus_indux = AudioServer.get_bus_index(bus_name)
